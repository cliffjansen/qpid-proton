...
reconnect_options& reconnect_options::update(const reconnect_options& x) {
    impl_->update(*x.impl_);
    return *this;
}

reconnect_options& reconnect_options::enabled(bool b) { impl_->enabled = b; return *this; }
reconnect_options& reconnect_options::initial_delay(duration d) { impl_->initial_delay = d; return *this; }
...
reconnect_options::impl *reconnect_options::implref() { return impl_.get(); }
